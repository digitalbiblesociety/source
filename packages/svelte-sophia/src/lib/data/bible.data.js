export const bible_data = {
	...
	'2SA': {
		...
		names: {
			en: ['2 Samuel', '2S', '2 Sam', '2Sam', '2 Sa', '2Sa', 'II Samuel', 'II Sam', 'II Sa', 'IIS']
		}
	},
	'1KI': {
	...
	'2KI': {
		...
		names: {
			en: ['2 Kings', '2K', '2 Kin', '2Kin', '2 Ki', 'IIK', '2Ki', 'II Kings', 'II Kin', 'II Ki']
		}
	},
	'1CH': {
		...
		names: {
			en: ['1 Chronicles', '1Ch', '1 Chr', '1Chr', '1 Ch', 'ICh', 'I Chronicles', 'I Chr', 'I Ch']
		}
	},
	'2CH': {
	...
	SIR: {
		...
		abbr: { en: ['Sir'] },
		chapters: [
			30, 18, 31, 31, 15, 37, 36, 19, 18, 31, 34, 18, 26, 27, 20, 30, 33, 30, 32, 28, 27, 28, 34,
			26, 29, 30, 26, 28, 25, 31, 24, 31, 26, 20, 26, 31, 34, 35, 30, 24, 25, 33, 22, 26, 20, 25,
			25, 16, 29, 30
		],
	...
	'1TI': {
		...
		names: {
			en: ['1 Timothy', '1Ti', '1 Tim', '1Tim', '1 Ti', 'ITi', '1Ti', 'I Timothy', 'I Tim', 'I Ti']
		}
	},
	'2TI': {
	...
	'3JN': {
		...
		chapters: [14],
		names: {
			en: ['3 John', '3J', '3 Jn', '3 Jn', '3Jn', '3 Jo', 'IIIJo', 'III John', 'III Jo', 'III Jn']
		}
	},
	JUD: {
		name: "Jude's Letter",
	...
	OTH: { name: 'Other', order: 98, osis: 'Other', chapters: [], names: { en: ['Other'] } },
	XXA: {
		name: 'XXA',
		order: 99,
		osis: 'XXA',
...
export const addNames = function (data, lang, usfmBookList, namesData, abbrData) {

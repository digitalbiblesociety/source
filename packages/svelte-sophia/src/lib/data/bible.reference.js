 class BibleReference {
	...
	getBook() {		
		...
		var book = bible.BIBLE_DATA[this.book_id];
		return book;
	}	
	 ...
	 */
	toChapterCode() {
		return this.book_id + '_' + (this.chapter1 > 0 ? this.chapter1 : '1');
	}
	 ...
	 */
	toVerseCode() {
		return this.book_id + '_' + (this.chapter1 > 0 ? this.chapter1 : '1') + '_' + (this.verse1 > 0 ? this.verse1 : '1');
	}	
	...
	static parse(textReference, language = 'en') {
		...
		if (possibleMatch != null) {
			...
			if (book_id != null) {
				...
				// just book
				if (book_id != null && chapter1 <= 0 && verse1 <= 0 && chapter2 <= 0 && verse2 <= 0) {
					chapter1 = 1;
					//verse1 = 1;
				}
		...
		// finalize
		return new BibleReference(book_id, chapter1, verse1, chapter2, verse2);
	}	
}

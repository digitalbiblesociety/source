...
<div class="relative rounded-xl border dark:border-stone-700 bg-stone-100 dark:bg-stone-800">
	...
	{#if articles}
		<div class="mx-auto py-4 px-4 sm:px-6 lg:flex lg:items-center">
			<div class="relative z-20 lg:w-0 lg:flex-1">
				<h2 class="relative z-20 font-semibold uppercase tracking-wider text-blue-600 dark:text-stone-200">
					{$t("common.latest_article")}
				</h2>
				<h2 class="relative z-20 text-3xl font-extrabold text-stone-900 dark:text-stone-200 sm:text-2xl">
						...
						<a href="/about/projects/{article.slug}"
						   class="flex justify-left space-x-4">
							...
							<span
								...
								<ChevronDown class="h-4 w-4 text-stone-600 dark:text-stone-300 "/>
							</span>
						</a>
					</li>
				{/each}

...
<div class="relative rounded-xl border dark:border-stone-700 bg-stone-100 dark:bg-stone-800 max-w-5xl mx-auto">

	<div class="dark:text-invert absolute top-3 right-4 flex -translate-y-1/2 transform">
		<span class="rounded-lg border border-stone-500 bg-stone-600 p-1.5 dark:bg-stone-800 sm:p-2.5 md:rounded-xl">
	...
	<div class="px-auto py-5 sm:p-6">
	  ...
	  <div class="mt-2 max-w-xl mx-auto text-sm text-stone-500">

		<h2 class="font-semibold uppercase text-center tracking-wider text-blue-600 dark:text-stone-200">
		{$t("common.contact_subtitle")}
	</h2>
	<h2
		class="text-3xl sm:text-2xl text-center font-extrabold text-stone-900 dark:text-stone-200">
		{$t("common.contact_title")}
	</h2>
	<p
		class="mt-3 max-w-3xl text-stone-500 dark:text-stone-300">
	  ...
	  <form class="mt-5 flex items-center justify-center" action="https://formspree.io/f/xleoznoq" method="POST">
		<div class="w-full max-w-xs">
		  ...
		  <input type="email" name="email" id="email" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-stone-300 rounded-md" placeholder="{$t('common.contact_placeholder')}">
		</div>
	  ...
	  <div class="flex flex-row items-center justify-center sm:justify-left mx-auto">
		...
		<div class="flex pt-4 mx-4 items-center">
			...
			<span class="ml-3" id="annual-billing-label">
			  <span class="text-sm font-medium text-stone-900">Quarterly Newsletter</span>
		...
		<div class="flex pt-4 mx-4 items-center">
			...
			<span class="ml-3" id="annual-billing-label">
			  <span class="text-sm font-medium text-stone-900">Weekly Prayer Alerts</span>
			  <span class="text-sm text-stone-500"></span>
			</span>
		  </div>
	...
	<p class="mt-3 text-center text-sm text-stone-500 dark:text-stone-300">

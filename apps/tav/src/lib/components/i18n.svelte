...
<Menu>
	<MenuButton
		class="flex rounded-md p-1 md:px-2.5 text-sm rounded-md border border-gray-100 bg-gray-200 text-gray-700
		 		dark:bg-gray-600 dark:text-gray-200" aria-label="Language Select">
		<IconTranslate
			class="h-5 w-5 dark:placeholder-gray-400 md:mr-2" />

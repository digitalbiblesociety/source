	...
	<table class="text-center dark:bg-gray-300 ">
		<tbody>
			...
			<tr>
				...
				<td class="cost">
					$ {products["mini-pearl-audio-bible-player"]?.variants[0]?.price ??
						""}
				</td>
				<td class="cost">
					$ {products["pearl-audio-bible-player-1"]?.variants[0]?.price ?? ""}
				</td>
				<td class="cost">
					$ {products["village-audio-bible-player"]?.variants[0]?.price ?? ""}
				</td>
			</tr>
			<tr>
				<th scope="row" class="">
